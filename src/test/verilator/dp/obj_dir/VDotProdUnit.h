...
#ifndef VERILATED_VDOTPRODUNIT_H_
#define VERILATED_VDOTPRODUNIT_H_  // guard

#include "verilated.h"

class VDotProdUnit__Syms;
class VDotProdUnit___024root;
class VerilatedVcdC;
class VDotProdUnit_FADD;


// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VDotProdUnit VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VDotProdUnit___024root* const rootp;
    ...
    explicit VDotProdUnit(VerilatedContext* contextp, const char* name = "TOP");
    explicit VDotProdUnit(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VDotProdUnit();
  private:
    VL_UNCOPYABLE(VDotProdUnit);  ///< Copying not allowed
