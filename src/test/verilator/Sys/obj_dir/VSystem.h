...
#ifndef VERILATED_VSYSTEM_H_
#define VERILATED_VSYSTEM_H_  // guard

#include "verilated.h"

class VSystem__Syms;
class VSystem___024root;
class VerilatedVcdC;
class VSystem_Octet;


// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VSystem VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VSystem_Octet* const __PVT__System__DOT__top__DOT__tc__DOT__ot;
    VSystem_Octet* const __PVT__System__DOT__top__DOT__tc__DOT__ot_1;
    VSystem_Octet* const __PVT__System__DOT__top__DOT__tc_1__DOT__ot;
    VSystem_Octet* const __PVT__System__DOT__top__DOT__tc_1__DOT__ot_1;

    // Root instance pointer to allow access to model internals,
    // including inlined /* verilator public_flat_* */ items.
    VSystem___024root* const rootp;
    ...
    explicit VSystem(VerilatedContext* contextp, const char* name = "TOP");
    explicit VSystem(const char* name = "TOP");
