...
#ifndef VERILATED_VSYSTEM_OCTET_H_
#define VERILATED_VSYSTEM_OCTET_H_  // guard

#include "verilated.h"
class VSystem_DotProdUnit;


class VSystem__Syms;

class alignas(VL_CACHE_LINE_BYTES) VSystem_Octet final : public VerilatedModule {
  public:
    // CELLS
    VSystem_DotProdUnit* __PVT__tg__DOT__dp;
    VSystem_DotProdUnit* __PVT__tg__DOT__dp_1;
    VSystem_DotProdUnit* __PVT__tg__DOT__dp_2;
    VSystem_DotProdUnit* __PVT__tg__DOT__dp_3;
    VSystem_DotProdUnit* __PVT__tg_1__DOT__dp;
    VSystem_DotProdUnit* __PVT__tg_1__DOT__dp_1;
    VSystem_DotProdUnit* __PVT__tg_1__DOT__dp_2;
    VSystem_DotProdUnit* __PVT__tg_1__DOT__dp_3;
    ...
    // CONSTRUCTORS
    VSystem_Octet(VSystem__Syms* symsp, const char* v__name);
    ~VSystem_Octet();
    VL_UNCOPYABLE(VSystem_Octet);
