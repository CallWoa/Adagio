...
#ifndef VERILATED_VTOP_DOTPRODUNIT_H_
#define VERILATED_VTOP_DOTPRODUNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VTop_DotProdUnit final : public VerilatedModule {
  public:
    // CELLS
    VTop_FADD* __PVT__faddModule;
    VTop_FADD* __PVT__faddModule_1;
    VTop_FADD* __PVT__faddModule_2;
    VTop_FADD* __PVT__faddModule_3;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__fcvt_1__DOT__subnormal_rounder_io_roundIn;
        CData/*0:0*/ __PVT__fcvt_1__DOT__subnormal_rounder_io_stickyIn;
        CData/*0:0*/ __PVT__fcvt_1__DOT__expOverflow;
        CData/*0:0*/ __PVT__fcvt_1__DOT__rmin;
        CData/*0:0*/ __PVT__fcvt_1__DOT___common_exp_T_1;
        CData/*0:0*/ __PVT__fcvt_1__DOT___common_exp_T_4;
        CData/*0:0*/ __PVT__fcvt_1__DOT__normal_rounder__DOT__inexact;
        CData/*0:0*/ __PVT__fcvt_1__DOT__normal_rounder__DOT__r_up;
        CData/*0:0*/ __PVT__fcvt_1__DOT__subnormal_rounder__DOT__inexact;
    ...
    // CONSTRUCTORS
    VTop_DotProdUnit(VTop__Syms* symsp, const char* v__name);
    ~VTop_DotProdUnit();
    VL_UNCOPYABLE(VTop_DotProdUnit);
