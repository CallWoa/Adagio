...
VL_ATTR_COLD void VTop_DotProdUnit___ctor_var_reset(VTop_DotProdUnit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              VTop_DotProdUnit___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->__PVT__rm_s2 = VL_RAND_RESET_I(3);
    ...
    vlSelf->__PVT__rm_this = VL_RAND_RESET_I(3);
    ...
    vlSelf->__PVT__rm_sx = VL_RAND_RESET_I(3);
    ...
    vlSelf->__PVT__rm_es = VL_RAND_RESET_I(3);
    ...
    vlSelf->__PVT__fcvt_1__DOT__subnormal_rounder_io_roundIn = VL_RAND_RESET_I(1);
    vlSelf->__PVT__fcvt_1__DOT__subnormal_rounder_io_stickyIn = VL_RAND_RESET_I(1);
    vlSelf->__PVT__fcvt_1__DOT__expOverflow = VL_RAND_RESET_I(1);
    vlSelf->__PVT__fcvt_1__DOT__rmin = VL_RAND_RESET_I(1);
    vlSelf->__PVT__fcvt_1__DOT___common_exp_T_1 = VL_RAND_RESET_I(1);
    vlSelf->__PVT__fcvt_1__DOT___common_exp_T_4 = VL_RAND_RESET_I(1);
    vlSelf->__PVT__fcvt_1__DOT__normal_rounder__DOT__inexact = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__fcvt_1__DOT__subnormal_rounder__DOT__inexact = VL_RAND_RESET_I(1);
